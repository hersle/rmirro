...
sudo --user=$user kgx -- sh -c "cd $dir; echo \"Auto-synchronising reMarkable that was just connected with USB\"; echo \"User: \$USER\"; echo \"Directory: \$PWD\"; sleep 1; ./rmirro.py" &
